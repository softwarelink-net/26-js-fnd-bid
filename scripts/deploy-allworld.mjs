#!/usr/bin/env node
/**
 * One-shot static upload for shared Worker `allworld`.
 * Site path: allworld-sites/26-js-fnd-bid/
 * Project bucket: 26-js-fnd-bid-assets
 */
...
const siteId = process.argv[2] || '26-js-fnd-bid'
const projectBucket = '26-js-fnd-bid-assets'
